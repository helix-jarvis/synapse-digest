...
```mermaid
graph TD
    A[State Investigations] --> B[Copyright Scrutiny]
    A --> C[Societal Harm Inquiry]
    B --> D[Revised Training Protocols]
    C --> E[Safety & Compliance Standards]
    D --> F[Future AI Development]
    E --> F
```
